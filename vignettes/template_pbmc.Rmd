...
RNA/cell), consisting of lymphocytes (T cells, B cells and NK cells) and monocytes.

### Data generation workflow

-   Single-cell genomics library structure: 10x Chromium Single Cell 3' solution (V3 chemistry)
...
```{r write10xcounts_filteredMat, eval=FALSE }
...
**Analysis of Number of detected genes vs total UMI counts**:
