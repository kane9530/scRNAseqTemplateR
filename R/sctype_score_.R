...
# Modified by Kane Toh <kanetoh@nus.edu.sg>, March 2022
#
...
#' @param gene_names_to_uppercase boolean: indicates whether to convert gene names to uppercase letters (TRUE by default)
#' @param gs character vector: list of gene sets positively expressed in the cell type
#' @param gs2 character vector: list of gene sets that should not be expressed in the cell type (NULL if not applicable)
